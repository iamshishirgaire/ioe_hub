...
class MaterialTheme {
  ...
  ThemeData theme(ColorScheme colorScheme) => ThemeData(
        ...
        popupMenuTheme: PopupMenuThemeData(
            ...
            shape: RoundedRectangleBorder(
                side: BorderSide(color: colorScheme.outline.withAlpha(10)),
        ...
        chipTheme: ChipThemeData(
            ...
            secondarySelectedColor: colorScheme.onInverseSurface,
            ...
            showCheckmark: false,
            selectedColor: colorScheme.primary.withOpacity(0.7)),
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          enabledBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                  width: 1.3, color: colorScheme.outline.withOpacity(0.5))),
        ...
        dropdownMenuTheme: DropdownMenuThemeData(
            menuStyle: MenuStyle(
          maximumSize: const WidgetStatePropertyAll(Size.fromWidth(300)),
          fixedSize: const WidgetStatePropertyAll(Size.fromHeight(30)),
