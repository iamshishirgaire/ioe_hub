...
class NoteDetailsPage extends StatefulWidget {
  ...
  @override
  State<NoteDetailsPage> createState() => _PastQuestionDetailPageState();
}

class _PastQuestionDetailPageState extends State<NoteDetailsPage> {
  @override
  void initState() {
    super.initState();
            ...
            BlocConsumer<FileDownloadBloc, FileDownloadState>(
              listener: (context, state) => {
                if (state is FileDownloadSuccess)
                  {
                    context.read<OfflineNotesBloc>().add(
                          AddOfflineNote(
                              note: Offline(
                                  fileId: fileId,
